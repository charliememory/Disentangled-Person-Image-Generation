...
def get_split(split_name, dataset_dir, data_name='Market1501', file_pattern=None, reader=None):
    ...
    keys_to_features = {
         ...
         'pose_mask_r6_0': tf.FixedLenFeature([128*64*1], tf.int64),
    ...
    items_to_handlers = {
        ...
        'pose_mask_r6_0': slim.tfexample_decoder.Tensor('pose_mask_r6_0',shape=[128*64*1]),
        'pose_mask_r6_1': slim.tfexample_decoder.Tensor('pose_mask_r6_1',shape=[128*64*1]),
