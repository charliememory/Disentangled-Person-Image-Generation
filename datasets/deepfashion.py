...
def get_split(split_name, dataset_dir, data_name='DeepFashion', file_pattern=None, reader=None):
    ...
    keys_to_features = {
        'image_name_0' : tf.FixedLenFeature([], tf.string),
        'image_name_1' : tf.FixedLenFeature([], tf.string),
        ...
        'pose_mask_r8_1': tf.FixedLenFeature([256*256*1], tf.int64),
        ...
        'indices_r8_0': tf.VarLenFeature(dtype=tf.int64),
        'values_r8_0': tf.VarLenFeature(dtype=tf.float32),
    ...
    items_to_handlers = {
        ...
        'pose_mask_r8_1': slim.tfexample_decoder.Tensor('pose_mask_r8_1',shape=[256*256*1]),
        ...
        'part_vis_1': slim.tfexample_decoder.Tensor('part_vis_1',shape=[1*37]),
        # 'roi10_mask_0': slim.tfexample_decoder.Tensor('roi10_mask_0',shape=[256*256*10]),
        # 'roi10_mask_1': slim.tfexample_decoder.Tensor('roi10_mask_1',shape=[256*256*10]),
    }
